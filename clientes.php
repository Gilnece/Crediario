...
<body>
    <header class="menu">
        ...
        <nav class="navegacao" >
            ...
            <a href="ConsultarClientes.php">Consultar Clientes</a>
        </nav>
    </header>
    <main>
        <div class="form-container">
            ...
            <form method="POST" action="clientes.php">
                ...
                <div class="input-box">
                    ...
                    <input type="text" id="nome" name="nome" placeholder="Nome" maxlength="40">
                </div>
                ...
                <div class="input-box">
                    <label for="rua"></label>
                    <input type="text" id="rua" name="rua" placeholder="Rua" maxlength="40">
                </div>

                <div class="input-box">
                    <label for="bairro"></label>
                    <input type="text" id="bairro" name="bairro" placeholder="Bairro" maxlength="40">
                </div>

                <div class="input-box">
                    <label for="cidade"></label>
                    <input type="text" id="cidade" name="cidade" placeholder="Cidade" maxlength="40">
                </div>
                ...
                <input type="button" name="submit" class="btn" Value="Cadastrar Cliente" onclick="CadCliente()">
            </form>
        </div>
    </main>
